...
export default function Footer() {
  ...
  return (
    <footer className="w-full mt-auto py-5 px-4 sm:px-8 border-t border-white/5 light:border-slate-200 bg-app text-slate-400 light:text-slate-500 text-xs flex flex-wrap items-center justify-between gap-3 select-none">
